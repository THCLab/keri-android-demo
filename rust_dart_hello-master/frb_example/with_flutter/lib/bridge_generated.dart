...
class DartImpl extends FlutterRustBridgeBase<DartWire> implements Dart {
  factory DartImpl(ffi.DynamicLibrary dylib) => DartImpl.raw(DartWire(dylib));

  DartImpl.raw(DartWire inner) : super(inner);
